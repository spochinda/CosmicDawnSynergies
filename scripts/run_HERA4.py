...
for i,(nlive,(HERA,Chandra,LWA,SARAS,xHI)) in enumerate(zip(nlives,constraints)):
    ...
    settings.base_dir = path+'scripts/non-public/{0}HERA_{1}Chandra_{2}LWA_{3}SARAS_{4}xHI_globalemu315emu14testpipe_nlive_{5}'.format(*constraints[i].astype(int),settings.nlive)
