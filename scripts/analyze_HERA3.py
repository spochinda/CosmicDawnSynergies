...
TS_emu = poweremu(loadfile="data/trained_emulators_poweremu/TSemu_m1.pkl", preprocesss_log_x=False)
TK_emu = poweremu(loadfile="data/trained_emulators_poweremu/TKemu_m1.pkl", preprocesss_log_x=False, offset=1e-3)
TR_emu = poweremu(loadfile="data/trained_emulators_poweremu/TRemu_m1.pkl", preprocesss_log_x=False, offset=1e-3)
...
idr3.reset_index().to_feather("idr3.feather")
prior.to_hdf("prior.h5","prior")
prior.reset_index().to_feather("prior.feather")
