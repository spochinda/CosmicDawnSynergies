...
python analysis/plot_triangle_sdc3b.py --PS=PS2 --chains scripts/non-public/LikelihoodSDC3b_SDC3b_PS2 inferences/SDC3b_PS2_minmax/LikelihoodSDC3b --labels Legacy Reproduced
python analysis/SDC3b_xHI.py --PS=PS1 --chains scripts/non-public/LikelihoodSDC3b_SDC3b_PS1 inferences/SDC3b_PS1_minmax/LikelihoodSDC3b --labels Legacy Reproduced
python analysis/SDC3b_xHI.py --PS=PS2 --chains scripts/non-public/LikelihoodSDC3b_SDC3b_PS2 inferences/SDC3b_PS2_minmax/LikelihoodSDC3b --labels Legacy Reproduced
